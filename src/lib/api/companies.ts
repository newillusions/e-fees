...
export async function getCompanies(): Promise<Company[]> {
  try {
    ...
    logApiError('getCompanies', error as Error, { component: 'CompaniesApi' });
    throw error;
  }
}
...
export async function getCompaniesPage(
  ...
  try {
    ...
    logApiError('getCompaniesPage', error as Error, { component: 'CompaniesApi' });
    throw error;
  }
}
...
export async function getCompanyById(id: string): Promise<Company | null> {
  try {
    ...
    logApiError('getCompanyById', error as Error, { component: 'CompaniesApi' });
    throw error;
  }
}
...
export async function createCompany(company: CompanyCreate): Promise<Company> {
  try {
    ...
    logApiError('createCompany', error as Error, { component: 'CompaniesApi' });
    throw error;
  }
}
...
export async function updateCompany(id: string, company: CompanyUpdate): Promise<Company | null> {
  try {
    ...
    logApiError('updateCompany', error as Error, { component: 'CompaniesApi' });
    throw error;
  }
}
...
export async function deleteCompany(id: string): Promise<Company | null> {
  try {
    ...
    logApiError('deleteCompany', error as Error, { component: 'CompaniesApi' });
    throw error;
  }
}
