/**
 * Projects Page - Load Error Visibility Regression Test
 *
 ...
 * component never read it - a failed load left projects=[] with no visible
 * indication anything went wrong, rendering "No Projects Yet" as if the
...
describe('Projects page - load error visibility', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    resetPaginatedStore();

    vi.mocked(invoke).mockImplementation(async (cmd: string) => {
      if (cmd === 'get_projects_page') {
