...
import { AgentApiClient, type AgentFeeResponse, type AgentProjectResponse, type AgentCompanyResponse, type AgentContactResponse } from '$lib/api/agent'
...
describe('Fee CRUD Operations - Agent API E2E', () => {
  ...
  afterAll(async () => {
    ...
    console.log(`Fee E2E: created ${createdFeeIds.length} fee(s), 1 project, 1 company, 1 contact with "${TEST_PREFIX}" prefix`)
  })
