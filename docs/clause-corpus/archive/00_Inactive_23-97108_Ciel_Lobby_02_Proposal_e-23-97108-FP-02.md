...
- **Project:** 23-97108 Ciel Lobby
- **Doc ID:** e-23-97108-FP-02
- **Status:** 00 Inactive
- **Client Name:** Stickman Tribe Ltd. (Marcos Cain)
- **Total Fee:** AED 173,000
- **Currency:** AED
...
**Fee Proposal**
Sensory Systems Design and Consultancy
Ciel tower Lobby
Dubai, UAE
e-23-97108-FP
Release 02
...
**Project Details**
The Project is known as Ciel tower Lobby and is located in Marina, Dubai, UAE
The Project is a proposed new development and currently comprises of:
- FoH Public Lobby Spaces

Reference documents: 23-912 Ciel Tower Lobby.zip
...
- All Systems:
  ...
  - External Spaces and Facades

Please note that as the structure is generally completed, Acoustic works will be limited to "internal room" recommendations as it is no longer possible to alter the completed works in order to mitigate "room to room" vibrations.
...
- Provide recommendations on package requirements [such as lux levels, uniformities, resolution, sound levels, reverberation times and intelligibility as required]
...
- Identify and recommend appropriate acoustic treatments as required
...
| 1 | Concept Design | 3 weeks |
| 2 | Schematic Design | 2 weeks |
| 3 | Detailed Design | 3 weeks |
...
|-------|-----------|-----------|
| 1 | Concept Design | 59,250 |
| 2 | Schematic Design | 52,500 |
| 3 | Detailed Design | 61,250 |
| - | Total | 173,000 |
...
|-------|-----------|-----------|---------------|
| - | Mobilisation | - | 30% — 51,900 |
| 1 | Concept Design | 52,500 | 41,950 |
| 2 | Schematic Design | 45,000 | 35,200 |
| 3 | Detailed Design | 52,500 | 43,950 |
| - | Total | 173,000 | - |
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference e-23-97108-FP r02.
