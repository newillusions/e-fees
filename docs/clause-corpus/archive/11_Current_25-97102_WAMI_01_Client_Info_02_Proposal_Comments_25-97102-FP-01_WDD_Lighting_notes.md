# Fee Proposal Archive

**Project:** 25-97102 WAMI
**Doc ID:** 25-97102-FP-01 (Release 1)
**Status:** 11 Current
**Client Name:** Wynn Al Marjan Island FZ-LLC
**Total Fee:** AED 1,069,440 (Review and Report Phase); Post Contract Phase fees TBC / Time and Material
**Currency:** AED
...
We can be appointed in a number of ways and tailor our services to a specific project and Clients' needs. All project teams are overseen by a Director and/or Associate to ensure a high level of service at all times.
...
- Validated all lighting control groups.
...
**Previous Works**
Emittiv has undertaken similar roles in the past, on equivalent scale projects.
A selection of references includes:

SeaWorld
Role: Specialist Consultant to Contractor
Duration: 2020-2021
...
emittiv confirms that we are prepared to accept the appointment based on the information included in this proposal. emittiv confirms that we are suitably qualified and have the capacity to deliver this project to professional standards.
...
- **Back of House:** Back of House areas will be reviewed on a case by case basis. [Suggested addition noted: BOH is to be part of the scope.]
...
## Scope & Services — Services Overview

**Services**

This proposal includes the services described below and is divided into Stages 1-3. Each Stage will progress in sequence, after receiving approval confirmation from the Client for the previous Stage's work. Specific Deliverables will be reviewed and agreed with the Client during each stage.
...
We propose the following programme, commencing with receipt of a fully executed contract. These estimations of work stage durations do not take into consideration Client review or Revision periods. The durations shown are to be confirmed with the Client during Preliminaries. Requests to reduce deliverable time frames may require additional staff and fees.

Review and Report Phase:
- Preliminaries: 2 weeks
- Stage 1 — Information Gathering: 6 weeks
- Stage 2 — Report and Recommendations: 8 weeks

Post Contract Phase:
- Stage 3 — On-going Support and Validation: TBC
...
Post Contract Fees are estimates based on previous experiences with similar projects. These numbers should be used for budgetary purposes only and may alter during the execution stage. Before exceeding the above fee due to an increase in the scope of the project, increased attendance requirements, or due to changes and / or revisions after Stage 2 has been approved, emittiv will notify the Client in writing in order to secure written approval. In this event, the additional fee to be charged will be agreed at that time.
...
| Stage | Milestone | Unit | Weekly Rate (AED) |
|---|---|---|---|
...
Daily billing rates applicable to this project will be as indicated in the included rate card, excluding travel, accommodation and ancillary costs. Additional expenses related to the Project will be charged and invoiced separately. Any additional fees or expenses shall be notified and approved in writing by the Client prior to emittiv proceeding.
Documentation and payment approvals are required before work on the next stage will begin. Further revision of the designs and resubmissions, if required, will be charged at the nominated rates. Any additional consulting, review, or design services performed beyond the scope of this proposal will be invoiced on the basis of pre-determined daily billing rates or on the basis of a mutually agreed fixed fee.
...
| Role | Hour (AED) | Day (AED) | Week (AED) | Month (AED) |
|---|---|---|---|---|
...
## Deliverables — Proposed Deployments

**Proposed Deployments — Review and Report Phase**

Review and Report Phase — Stage 1 and Stage 2 deployment allocation by role and week:

Total Fees Review and Report Phase: AED 1,069,440 (Stage 1: 483,360 | Stage 2: 586,080)

**On-going Support and Validation Phase — Stage 3 Weekly Fee Configurations:**

| Config | Description | Weekly Fee (AED) |
|---|---|---|
...
Martin Robert — emittiv founder, Lighting and Control Specialist. Specialties: Lighting, Video, Control Systems. 30+ years experience across global tours with A-List artists, permanent installations on iconic buildings, consulting for global events.

Sky Bembury — Lighting Designer. Specialties: Lighting Design, Product Development, Control Systems. 20+ years across USA, Europe and the Middle East. Lead designer for custom fittings and fixtures.

Ryan Marginson — Lighting Designer and Project Manager. Specialties: Lighting Design, Technical Direction, Project Management. 20 years' experience across Australia, Asia and the Middle East.

Daryl Bowen — Lighting Control Specialist. Specialties: Lighting Design, System Commissioning, Control Systems. 30+ years across UK, Europe, Africa, Middle East, Asia, and Oceania.

Goran Salkovic — Lighting Designer and Project Manager. Specialties: Installation Supervision, System Commissioning, Control Systems. 20+ years, background in large scale events and high profile venues.
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference 25-97102-FP r1. If you have any questions, or would like to discuss this further, please do not hesitate to contact us. We look forward to working with you on this project.
