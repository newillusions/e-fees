...
**Doc ID:** e-23-97105-FP-01
**Status:** 00 Inactive
**Client:** Stickman Tribe Turnkey Projects Contracting LLC (Marcos Cain)
...
Date: 230523 | Release: 01 | Author: AH | Reference: RFP

Distribution

Date: 230523 | Release: 01 | Distribution: Andrew Hawkes, Marcos Cain
...
## Design Phase Notes (Assumptions)
...
|---|---|---|---|
| - | Mobilisation | - | 30% / 36,000 |
| 1 | Concept Design | 40,000 | 28,000 |
| 2 | Schematic Design | 35,000 | 25,000 |
| 3 | Detailed Design | 35,000 | 25,000 |
| 4 | Tender Documentation | 10,000 | 6,000 |
| | **Total** | **120,000** | |
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference e-23-97105-FP r01 as the ordered services.
