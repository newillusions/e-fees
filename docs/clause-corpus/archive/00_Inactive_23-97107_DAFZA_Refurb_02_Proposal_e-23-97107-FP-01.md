...
**Project:** 23-97107 DAFZA Refurb
**Doc ID:** e-23-97107-FP-01 (document header references e-23-97197-FP r01)
**Status:** 00 Inactive
**Client:** P&T Group (attn. Raed Al Sayyed, Senior Associate)
**Total Fee:** AED 124,000
**Currency:** AED
**Date:** 230621 (21 June 2023)
...
- Email request of 18 Jun 2023
- 20230608 Options Presentation-Public realm option 5B
- 5925-20230615-P58-QS-00-Sub-consultancy Agreement
- 5925-P58-Program-R2 draft
- Main Agreement
...
**Project Details**
The Project is known as DAFZA Refurbishment and is located in DAFZA, Dubai, U.A.E.
The Project is a proposed refurbishment and currently comprises of:
- "Inner Circle" Public Realm areas
...
- Produce presentation materials to convey the overall design intent
- Provide recommendations on package requirements [such as lux levels, uniformities, etc. as required]
- Carry out preliminary development of package design
- Carry out preliminary development of package specific 2D layouts based on supplied files
...
## Stage 4 - Tender Return Evaluation
...
| 1 | Preliminary Design | 7 weeks |
| 2 | Final Design | 5 weeks |
| 3 | Tender Documentation | 4 weeks |
| 4 | Tender Return Review | 2 weeks |
...
|-------|-----------|-----------|
| - | Preliminaries | - |
| 1 | Preliminary Design | 43,400 |
| 2 | Final Design | 49,600 |
| 3 | Tender Documentation | 18,600 |
| 4 | Tender Return Review | 12,400 |
| | **Total** | **124,000** |
...
|-------|-----------|-----------|---------------|
| - | Mobilisation | - | 37,200 (30%) |
| 1 | Preliminary Design | 43,400 | 34,100 |
| 2 | Final Design | 49,600 | 40,300 |
| 3 | Tender Documentation | 18,600 | 9,300 |
| 4 | Tender Return Review | 12,400 | 3,100 |
| | **Total** | **124,000** | |
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference e-23-97197-FP r01.
