...
**Project:** 23-96604 DockX
**Doc ID:** e-23-96604-FP-01
**Status:** 00 Inactive
**Client Name:** KCC Entertainment Design (Louis Martens, Design Department Director)
**Total Fee:** EUR 62,500
**Currency:** EUR
...
230508 | 01 | Martin Robert, Louis Martens
...
emittiv ["Consultant", "We"] have received a Request for Proposal from KCC Entertainment Design ["Client"].

Reference documents provided by the Client, which form the basis of this proposal include:
- Email request of 28 Apr 2023
- WeTransfer Info pack: 22053_dockx_ 2023-04-28.zip
...
**Project Details**
The Project is known as DockX and is located in Jeddah, KSA
The Project is a proposed new development and currently comprises of:
- Total Plot Area: Approximately 3700 m2
...
- Prepare final package equipment schedule with indicative pricing
...
It is noted that this project is hoping to achieve quick turnarounds on the design stages, and efforts shall be made to accommodate this desire.

Requests to reduce deliverable time frames may require additional staff and fees.

**Site Attendance**

We understand that all works are to be undertaken remotely in conjunction with the Client's Wielsbeke based office.
This proposal does not provide for any travel out of country. If required, these will be charged at the prevailing daily rates, plus travel, accommodation, and ancillary costs.
...
Stage | Milestone | Fee
1 | Concept Design | 12,500
2 | Schematic Design | 25,000
3 | Detailed Design | 25,000
Total | | 62,500
...
Mobilisation | | | 30% / 18,750
1 | Concept Design | 12,500 | 6,250
2 | Schematic Design | 25,000 | 18,750
3 | Detailed Design | 25,000 | 18,750
Total | | 62,500 |
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference e-23-96604-FP r01.
