...
| Field | Value |
|---|---|
| Project | 25-97103 Aljada FG |
| Doc ID | 25-97103-FP-01 |
| Status | 00 Inactive |
| Client Name | Jouzy (Ramez Bakr, Head of Electrical Engineering) |
| Total Fee | Not stated as a single combined total; Block F Design Phase: AED 550,000; Block G Design Phase: AED 1,125,000; Block F Post Contract (estimated): AED 4,646,480; Block G Post Contract (estimated): AED 4,646,480 |
| Currency | AED |
...
**Fee Proposal — Specialist Lighting Design and Consultancy**
...
|---|---|---|
| 250417 | 01 | Martin Robert, Ramez Bakr |
...
emittiv ["Consultant", "We"] have received a Request for Proposal from Jouzy ["Client"].

Reference documents provided by the Client, which form the basis of this proposal include:
- Email request of 17 Apr 2025
- Onedrive links provided in above email
...
- Lighting
- Home Automation [Block G only]

**Project Details**
The Project is known as Aljada Block F + G and is located in Aljada, Sharjah, U.A.E.

The Project is a proposed new development and currently comprises of:
- Block F: [Offices + Retail spaces]
  - Total Plot Area: 407,234m2
  - 6 buildings - max B3+G+8
  - All Retail, F&B, and Office spaces are shell & core
- Block G: [Offices + Retail spaces]
  - Total Plot Area: 33,500 + 29,600 + 39,400 m2
  - 3 x twin buildings - max B+G+9+R
...
- Home Automation:
  - Block G residences only
  - Scope for this discipline is unclear and shall be confirmed prior to commencing works
...
- Design Phase
  ...
  - Stage 4T Tender Documentation
  - Stage 5 IFC Documentation
- Post Contract Phase [Optional]
  - Stage 6 Construction Supervision
  - Stage 6a Scene Setting and Aiming
  - Stage 7 DLP
...
This proposal includes the services described below and is divided into Stages 2-6.
...
**Stage 2 - Concept Design [Excluded from Block F scope]**
...
**Stage 7 - Post Completion / DLP [RIBA]**
...
The durations shown are as defined with the Client in the scope documents.
Any changes to the durations shown may incur additional fees.

| Stage | Milestone | Duration |
|---|---|---|
| - | Preliminaries | 2 weeks |
| 2 | Concept Design | 4 weeks |
| 3 | Schematic Design | 6 weeks |
| 4 | Detailed Design | 6 weeks |
| 4T | Tender Documentation | 4 weeks |
| 5 | IFC Documentation | 6 weeks |

Post Contract Phase

| Stage | Milestone | Duration |
|---|---|---|
| 6 | Construction Supervision | 24 months |
| 6a | Scene Setting | 3 months |
| 7 | DLP | 12 months |

Site Attendance: We understand that all works are to be undertaken in conjunction with the Client's Dubai based office. This proposal does not provide for any travel out of country. If required, these will be charged at the prevailing daily rates, plus travel and accommodation costs. In the interest of efficiency and safety, emittiv prefers remote meetings wherever possible.
...
**Block F: [Specialist Lighting] — Design Phase - Lump Sum Fees**

| Stage | Milestone | Total Fee (AED) |
|---|---|---|
| 3 | Schematic Design | 192,500 |
| 4 | Detailed Design | 220,000 |
| 4T | Tender Documentation | 82,500 |
| 5 | IFC Documentation | 55,000 |
| - | Total | 550,000 |

**Block G [Specialist Lighting and Home Automation] — Design Phase - Lump Sum Fees**

| Stage | Milestone | Total Fee (AED) |
|---|---|---|
| 2 | Concept Design | 281,250 |
| 3 | Schematic Design | 337,500 |
| 4 | Detailed Design | 337,500 |
| 4T | Tender Documentation | 90,000 |
| 5 | IFC Documentation | 78,750 |
| - | Total | 1,125,000 |
...
**Block F: [Specialist Lighting] — Post Contract Phase - Time Based Fees**

| Stage | Milestone | Unit | Est Qty | Price (AED) | Est. Fee (AED) |
|---|---|---|---|---|---|
| 6 | Construction Supervision | month | 24 | 91,520 | 2,196,480 |
| 6a | Scene Setting | month | 3 | 770,000 | 2,310,000 |
| 7 | DLP | visit | 4 | 35,000 | 140,000 |
| - | Estimated Total | | | | 4,646,480 |

**Block G [Specialist Lighting and Home Automation] — Post Contract Phase - Time Based Fees**
...
**Payment Schedule - Block F**

| Stage | Milestone | Fee (AED) | Payment (AED) |
|---|---|---|---|
| - | Mobilisation | 30% | 165,000 |
| 3 | Schematic Design | 192,500 | 151,250 |
| 4 | Detailed Design | 220,000 | 178,750 |
| 4T | Tender Documentation | 82,500 | 41,250 |
| 5 | IFC Documentation | 55,000 | 13,750 |
| - | Total | 550,000 | |

**Payment Schedule - Block G**

| Stage | Milestone | Fee (AED) | Payment (AED) |
|---|---|---|---|
| - | Mobilisation | 30% | 337,500 |
| 2 | Concept Design | 281,250 | 213,750 |
| 3 | Schematic Design | 337,500 | 270,000 |
| 4 | Detailed Design | 337,500 | 270,000 |
| 4T | Tender Documentation | 90,000 | 22,500 |
| 5 | IFC Documentation | 78,750 | 11,250 |
| - | Total | 1,125,000 | |
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference 25-97103-FP r1.
