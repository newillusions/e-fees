...
| Field | Value |
|---|---|
| Project | 25-97109 Mapletree Warehouse |
| Doc ID | 25-97109-FP-01 |
| Status | 00 Inactive |
| Client Name | P&T Group (Emily Mandu, Bid Coordinator) |
| Total Fee | AED 185,000 |
| Currency | AED |
...
The Project is known as JAFZA - Mapletree Warehouse and is located in JAFZA, Dubai, U.A.E. The Project is a proposed new development and currently comprises of:
- Total Plot Area: Approximately 164,230 m2
- Total Warehouses: 2 [Approximately 302,200 m2 in total]

Reference documents:
- Email request of 26 Nov 2025
- 0000-PTG-PM-DMP-RP-IM-0000101.pdf
- 03_Reference Consultancy Service Agreement.pdf
- 20251103 Middle East Logs - Consultant.pdf
- Mapletree Jafza Programme.xlsx
- PJ 1717 Areas 251121-1.xlsx
...
- Lighting:
  ...
  - Any Shell and Core tenanted spaces
...
- Copies of all relevant codes, standards and/or regulations etc. that may be required for the design work will be provided to emittiv by the Client
...
| 1 | Concept Design | 5 weeks |
| 2 | Schematic Design | 6 weeks |
| 3 | Detailed Design | 8 weeks |
| 4 | Tender Documentation | 12 weeks |
...
Back to back payments are not acceptable. Retention is not acceptable.
...
|---|---|---|---|
| - | Mobilisation | - | 37,000 (20%) |
| 1 | Concept Design | 46,250 | 37,000 |
| 2 | Schematic Design | 55,500 | 46,250 |
| 3 | Detailed Design | 64,750 | 55,500 |
| 4 | Tender Documentation | 18,500 | 9,250 |
| | **Total** | **185,000** | |
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference 25-97109-FP-1 r0. If you have any questions, or would like to discuss this further, please do not hesitate to contact us. We look forward to working with you on this project.
