...
**Project:** 24-96601 Dammam Water Park
**Doc ID:** e-24-96601-FP-01
**Status:** 00 Inactive
**Client:** Sim Leisure Gulf Contracting LLC
**Total Fee:** AED 2,100,000
**Currency:** AED
...
**Fee Proposal — Sensory Technologies Design and Consultancy — Dammam Water Park — Dammam, K.S.A. — e-24-96601-FP — Release 01**
...
Date: 240207
Release: 01
Distribution: Martin Robert, Josie Booth, Karen Stojanovski
...
emittiv ["Consultant", "We"] have received a Request for Proposal from Sim Leisure Gulf Contracting LLC ["Client"].

Reference documents provided by the Client, which form the basis of this proposal include:
- Email request of 19 Jan 2024
- 50% SD Information Packs Provided
...
Validity: This proposal shall remain valid for a period of sixty [60] days from the date of issue.

Project Details: The Project is known as Dammam Water Park and is located in Waterfront, Dammam, K.S.A. The Project is a proposed new development and currently comprises of:
- Total Plot Area: Approximately 105,000 m2

Packages: This Proposal includes the following technologies [referred to as packages or systems]:
- Lighting
- Video
- Sound
- Special FX
...
Stages: This proposal includes the following project stages:
- Design Phase
  - Preliminaries
  - Stage 1   Schematic Design [Show Systems]
  - Stage 2   Detailed Design [Show and Site Wide Systems]
  - Stage 3   Tender Documentation [Show and Site Wide Systems]
...
- The Client shall provide suitable Schematic Design information packages [including LOD 200 Revit Models.] It is assumed that these shall be sufficient for us to proceed with design works.
- Concept design shall be provided by the Client for the Show Systems. It is assumed that these shall be sufficient for us to proceed with design works.
...
**Stage 2 – Schematic Design [Show Systems]**
...
**Stage 3 - Detailed Design [Sitewide and Show systems]**
...
**Stage 4 - Tender Documents [Sitewide and Show systems]**
...
**Anticipated Programme — Design Phase**
...
|---|---|---|
| - | Preliminaries | 4 weeks |
| 1 | Schematic Design | TBC |
| 2 | Detailed Design | TBC |
| 3 | Tender Documentation | TBC |
...
|---|---|---|
| - | Preliminaries | 105,000 |
| 1 | Schematic Design | 357,000 |
| 2 | Detailed Design | 1,365,000 |
| 3 | Tender Documentation | 273,000 |
| **Total** | | **2,100,000** |
...
|---|---|---|---|
| - | Mobilisation | 10% | 210,000 |
| - | Preliminaries | 105,000 | 52,500 |
| 1 | Schematic Design | 357,000 | 304,500 |
| 2 | Detailed Design | 1,365,000 | 1,312,500 |
| 3 | Tender Documentation | 273,000 | 220,500 |
| **Total** | | **2,100,000** | |
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference e-24-96601-FP r01. If you have any questions, or would like to discuss this further, please do not hesitate to contact us. We look forward to working with you on this project.
