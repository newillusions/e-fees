...
| Field | Value |
|---|---|
| Project | 24-97112 Military Museum |
| Doc ID | 24-97112-FP-01 |
| Status | 00 Inactive |
| Client Name | Tabanlioglu Architects (contact: Umar Sikandry) |
| Total Fee | AED 877,500 |
| Currency | AED |
...
**Fee Proposal — Specialist Sensory Systems Design and Consultancy**
UAE National Military Museum, Abu Dhabi, U.A.E.
24-97112-FP | Release 1
...
|---|---|---|
| 240926 | 01 | Martin Robert, Umar Sikandry |
...
emittiv ["Consultant", "We"] have received a Request for Proposal from Tabanlioglu Architects ["Client"].

Reference documents provided by the Client, which form the basis of this proposal include:
- Email request of 24 Sep 2024
- Info pack provided in above email
...
The Project is known as UAE National Military Museum and is located in Al Bateen, Abu Dhabi, U.A.E.
The Project is a proposed new development and currently comprises of:
- Total Plot Area: Approximately 161,500m2
- Total Floors: B-G-1 — Approximately 33,025m2
- Areas as outlined in the supplied Area Table
...
This proposal includes the services described below and is divided into Stages 1-5.
...
Typical deliverables include:
- Assist others with the final coordination of the package design
- Update final BoQs and specifications
...
We propose the following programme, commencing with receipt of a fully executed contract. These estimations of work stage durations do not take into consideration Client review or Revision periods. The durations shown are to be confirmed with the Client during Preliminaries.

| Stage | Milestone | Duration |
|---|---|---|
| — | Preliminaries | 1 month |
| 1 | Concept Design | 1.5 months |
| 2 | Schematic Design | 2.5 months |
| 3 | Detailed Design | 4 months |
| 4 | Tender Documentation | 2 months |
| 5 | IFC Documentation | 1.5 months |

Requests to reduce deliverable time frames may require additional staff and fees.

Note: Construction Supervision shall be proposed at a later date upon confirmation of the project.
...
|---|---|---|
| 1 | Concept Design | 219,375 |
| 2 | Schematic Design | 219,375 |
| 3 | Detailed Design | 263,250 |
| 4 | Tender Documentation | 87,750 |
| 5 | IFC Documentation | 87,750 |
| — | **Total** | **877,500** |

**Design Phase - Department Fees**

| Stage | Milestone | Lighting | Video | Audio | SFX | Control | Acoustics | Stage Fee |
|---|---|---|---|---|---|---|---|---|
| 1 | Concept Design | 59,063 | 50,625 | 42,188 | 8,438 | 16,875 | 42,188 | 219,375 |
| 2 | Schematic Design | 59,063 | 50,625 | 42,188 | 8,438 | 16,875 | 42,188 | 219,375 |
| 3 | Detailed Design | 70,875 | 60,750 | 50,625 | 10,125 | 20,250 | 50,625 | 263,250 |
| 4 | Tender Documentation | 23,625 | 20,250 | 16,875 | 3,375 | 6,750 | 16,875 | 87,750 |
| 5 | IFC Documentation | 23,625 | 20,250 | 16,875 | 3,375 | 6,750 | 16,875 | 87,750 |
| — | **Total** | **236,250** | **202,500** | **168,750** | **33,750** | **67,500** | **168,750** | **877,500** |
...
|---|---|---|---|
| — | Mobilisation | — | 30% / 219,375 |
| 1 | Concept Design | 219,375 | 175,500 |
| 2 | Schematic Design | 219,375 | 175,500 |
| 3 | Detailed Design | 263,250 | 219,375 |
| 4 | Tender Documentation | 87,750 | 43,875 |
| 5 | IFC Documentation | 87,750 | 43,875 |
| — | **Total** | **877,500** | — |
...
Daily billing rates applicable to this project will be AED 4,750 per person per day, excluding travel, accommodation and ancillary costs.
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference 24-97112-FP r1.
