# Archive: e-24-97101-FP-01

| Field | Value |
|---|---|
| Project | 24-97101 HoH Supervision |
| Doc ID | e-24-97101-FP-01 |
| Status | 99 Completed |
| Client Name | Hyperspace FZ-LLC (attn: Lizzie Wafer) |
| Total Fee | AED 628,500 (estimated) |
| Currency | AED |
...
**Fee Proposal — Specialist Lighting Ongoing Supervision**
House of Hype Dubai
Dubai, UAE
e-24-97101-FP
Release 01
...
emittiv ["Consultant", "We"] have received a Request for Proposal from Hyperspace FZ-LLC ["Client"].
...
**Project Details**
The Project is known as House of Hype Dubai and is located in Dubai Mall, Dubai, UAE. The Project is a proposed new development and currently comprises of:
...
**Total Plot Area:** Approximately 100,000 ft2
**Total Built Up Area:** Approximately 38 Experience Zones

---

## Post Contract Phase Notes

This proposal includes the services described below and is divided into Stages 1-7. Each Stage will progress in sequence, after receiving approval confirmation from the Client for the previous Stage's work. The deliverables outlined in this document are typical for similar projects of this type and scale. Specific Deliverables will be agreed with the Client during Preliminaries, within the time frames allowed for in this proposal.

**Stage 1 - Contractor Return Evaluation**
...
**Stage 4 - Installation Supervision**
Typical deliverables include:
...
**Stage 7 - Hand Over and Training**
Typical deliverables include:
...
This proposal allows for 5 days of work in this stage. This is intended to be completed by the Designer and will be broken down to allow for session planning and delivery for the Lighting Control System. The Contractor shall provide training for the operation and maintenance of the installed fittings and devices. These sessions shall be attended by emittiv to confirm sufficient information is provided to the operations staff.
...
**Anticipated Programme — Post Design Phase**
...
|---|---|---|
| 1 | Tender Return Review | 4 weeks |
| 2 | Contractor / Procurement Management | 6 weeks |
| 3 | Shop Drawing Review | 6 weeks |
| 4 | Installation Supervision | 6 months |
| 5 | Commissioning Validation | 15 days |
| 6 | Programming Supervision | 15 days |
| 7 | Handover / Training | 5 days |
...
**Post Design Phase - Time Based Fees**
...
Before exceeding the above fee due to an increase in the scope of the project, increased attendance requirements, or due to changes and / or revisions after Stage 3 has been approved, emittiv will notify the Client in writing in order to secure written approval. In this event, the additional fee to be charged will be agreed at that time.

| Stage | Milestone | Unit | Est Qty | Price (AED) | Est. Fee (AED) |
|---|---|---|---|---|---|
| 1 | Tender Return Review | task | 1 | 35,000 | 35,000 |
| 2 | C / P Management | day | 6 | 6,750 | 40,500 |
| 3 | Shop Drawing Review | task | 1 | 85,000 | 85,000 |
| 4 | Installation Supervision | day | 6 | 29,250 | 175,500 |
| 5 | Commissioning Validation | day | 15 | 9,000 | 135,000 |
| 6 | Programming Supervision | day | 15 | 9,000 | 135,000 |
| 7 | Handover / Training | day | 5 | 4,500 | 22,500 |
| **Estimated Total** | | | | | **628,500** |
...
Daily billing rates applicable to this project will be AED 4,500 per person per day, excluding travel, accommodation and ancillary costs. Daily rates for in house staff are available on our rate card. Please request a copy of this document if required.
...
| Stage | Milestone | Fee (AED) | Payment |
|---|---|---|---|
| 1 | Tender Return Review | 35,000 | 50/50 |
| 2 | Contractor / Procurement Management | 40,500 | invoiced monthly |
| 3 | Shop Drawing Review | 85,000 | 50/50 |
| 4 | Installation Supervision | 175,500 | invoiced monthly |
| 5 | Commissioning Validation | 135,000 | invoiced monthly |
| 6 | Programming | 135,000 | invoiced monthly |
| 7 | Handover / Training | 22,500 | invoiced monthly |
| **Total** | | **628,500** | |
