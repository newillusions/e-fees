# Archive: e-22-97112-FP-01 - signed

| Field | Value |
|---|---|
| Project | 22-97112 The View Exp Ctr |
| Doc ID | e-22-97112-FP-01 - signed |
| Status | 00 Inactive |
| Client Name | Nakheel Malls (Ryan Marginson, Senior Manager - Technical Production) |
| Total Fee | AED 42,000 |
| Currency | AED |
...
**Fee Proposal — Audio Engineer Review and Programming, The View at the Palm**

Fee Proposal
Audio Engineer Review and Programming
The View at the Palm
Dubai, U. A .E.
e-22-97112-FP
Release 01

e-22-97112-FP-01 - 29 July 2022
Fee Proposal for Review and Programming of Audio Engineer
The View at the Palm
...
The Project is known as The View at the Palm and is located in Nakheel Mall, Dubai, U. A.E.
...
- SOW - AudioConsultant Mall Mang office ,The pointe, Plam Jumeirah.pdf
...
- All public areas within The View
...
**Services — System Tuning**

**Stage 1 - Review and Report of Current Sound System**

Anticipated content of report includes:
- Current issues and concerns
- Future proof and add on abilities / restrictions
- Recommendations on optimising content masters specific to environment
- Suggest acoustic enhancements to improve quality of sound
...
- EQ each area 'to the room and room dynamics'
- Programming of delays
- Re-Terminating speakers if and were necessary [to be quantified during inspection works]

We have allowed for up to one revision of the Concept Design Report.

**Notes**

- Any non-functional equipment cannot be evaluated or optimised and may required additional visits.
...
|---|---|---|
| 1 | Review & Report of current sound system | 1 week |
| 2 | Calibrate, EQ, setup the audio experiential experience | 1 week |

These estimations of work stage durations do not take into consideration Client review or Revision periods.
Note that the system tuning and calibration periods are expected to require 1 weeks' work. This time may extend beyond 1 calendar week to achieve.
Some non-disruptive works may be carried out during operational hours. This shall be coordinated and agreed with the client upon commencement.

The proposal allows for the following staff allocations:

| Stage | Milestone | Snr Engineer | Asst Engineer | Wireman |
|---|---|---|---|---|
| 1 | Review & Report | 2 days | N/A | N/A |
| 2 | Calibrate, EQ | 4 days | 4 days | 2 days |
...
|---|---|---|
| 1 | Review & Report of current sound system | 10,000 |
| 2 | Calibrate, EQ, setup the audio experiential experience | 32,000 |
| | Total | 42,000 |
...
We propose the following payment structure for the primary services:
...
Daily billing rates applicable to this project will be:
- Senior Engineer: AED 5,000 per day
- Assistant Engineer: AED 2,250 per day
- Wireman: AED 1,500 per day

A senior engineer is required to be on site with any other staff.
Additional expenses related to the Project will be charged and invoiced separately.
Any additional fees or expenses shall be approved in writing by the Client prior to emittiv proceeding.
...
The terms and conditions laid out in the ACE Professional Services Agreement shall form part of this proposal and read as contained herein.
...
emittiv's liability to the Client under any circumstances exceeds emittiv's liability to the Client under any circumstances shall not exceed the amount of compensation actually received by emittiv from the Client under any related Agreement as of a certain date.
