...
| Field | Value |
|---|---|
| **Project** | 25-97101 Shanghai Tang |
| **Document ID** | 25-97101-FP-02 |
| **Status** | 99 Completed |
| **Client Name** | Nicholas Fernandez, Director of Engineering, Conrad Hotels |
| **Total Fee** | AED 50,000 (Optional Acoustic scope: AED 27,500 additional) |
| **Currency** | AED |
...
**Fee Proposal — Lighting and Audio Design — Shanghai Tang, Abu Dhabi, U.A.E. — 25-97101 — Release 02**
...
250127 | 01 | MR | RFP
250204 | 02 | MR | Updates to fit client budget

Distribution

Date | Release | Distribution
250127 | 01 | Martin Robert, Andrew Hawkes, Nicholas Fernandez
250204 | 02 | Martin Robert, Andrew Hawkes, Nicholas Fernandez
...
- Email request of 17 Jan 2025
- Mood Board info of 17 Jan 2025
...
**Contract Details — Anticipated Programme — Design Phase**
...
2 | Detailed Design | 4 weeks
3 | Tender Documentation | 2 weeks
...
Stage | Milestone | Fee
— | Preliminaries | —
1 | Concept Design | 20,000
2 | Detailed Design | 25,000
3 | Tender Documentation | 5,000
— | Total | 50,000
...
— | Mobilisation | — | 30% / 15,000
1 | Concept Design | 20,000 | 15,000
2 | Detailed Design | 25,000 | 20,000
3 | Tender Documentation | 5,000 | —
— | Total | 50,000 | —
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference 25-97101 r02.
If the LPO is issued for a value of AED 77,500 it will be acknowledged that the Acoustic Consultancy has been ordered by the Client.
