...
| Field | Value |
|---|---|
| Project | 23-97109 Ciel VIP |
| Doc ID | e-23-97109-FP-01 |
| Status | 00 Inactive |
| Client Name | Stickman Tribe Ltd. (Marcos Cain) |
| Total Fee | AED 160,000 |
| Currency | AED |
...
**Project Details**
The Project is known as Ciel Tower VIP Suites and is located in Marina, Dubai, UAE.
The Project is a proposed new development and currently comprises of:
- Suite Types:
  - Royal Suite x 10
  - Presidential Suite x 20
  - Signature Suite x 78
  - Club Room x 151
  - Club Room [ADA] x 3
...
| Stage 1 - Concept Design | 4 weeks |
| Stage 2 - Schematic Design | 8 weeks |
...
|---|---|---|
| Preliminaries | - | - |
| 1 | Concept Design | 72,000 |
| 2 | Schematic Design | 88,000 |
| **Total** | | **160,000** |
...
|---|---|---|---|
| - | Mobilisation | - | 30% / 48,000 |
| 1 | Concept Design | 48,000 | - |
| 2 | Schematic Design | 64,000 | - |
| **Total** | | **160,000** | |
...
**Next Steps**
If you would like to proceed with this project, please issue an LPO mentioning the document reference e-23-97109-FP r01.
