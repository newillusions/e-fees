...
**Project:** 24-97111 Masdar City HQ Plot OS-48
**Doc ID:** 24-97111-FP-01
**Status:** 00 Inactive
**Client:** P&T Group (Emily Mandu, Bid Coordinator)
**Total Fee:** AED 280,000 (Design Phase lump sum; Post Contract TBC)
**Currency:** AED
**Date:** 26 August 2024 (Release 01)
...
Date: 240826 | Release: 01 | Author: MR | Reference: RFP

Distribution

Date: 240826 | Release: 01 | Distribution: Martin Robert, Emily Mandu
...
## Scope & Services — Proposal Response
...
**Project Details:** The Project is known as Masdar City HQ Plot OS-48 and is located in Masdar City, Abu Dhabi, U.A.E. The Project is a proposed new development and currently comprises of:
- Total Plot Area: Approximately 7,000 m2; GFA Approximately 3,500 m2
- Total Floors: G+2 max.
...
- Stage 5 — Issue for Construction
...
- The Project is required to meet:
  - LEED V4.0 Platinum
  - Estidama PBRS 05 Pearl
  - WELL Platinum
  - Masdar City's Energy Design Guidelines
- Vectorised copies of these standards shall be provided by the Client.
...
## Stages — Stage 5: IFC Documentation

This stage will prepare the design documents so they can be issued for construction to the awarded Contractor.

Typical deliverables include:
- Following approval of the previous stage provide documents for final construction and assistance in co-ordinating system design with architectural, electrical, structural and mechanical design.
...
Design Phase — We propose the following programme, commencing with receipt of a fully executed contract. These estimations of work stage durations do not take into consideration Client review or Revision periods. The durations shown are to be confirmed with the Client during Preliminaries.

| Milestone | Duration |
|---|---|
| Preliminaries | 1 week |
| Stage 1 — Concept Design | 10 weeks |
| Stage 2 — Schematic Design | 10 weeks |
| Stage 3 — Detailed Design | 12 weeks |
| Stage 4 — Tender Documentation | 3 weeks |
| Stage 5 — IFC Documentation | 3 weeks |

Requests to reduce deliverable time frames may require additional staff and fees.

**Post Contract Phase:** TBC during design stages.
...
| Stage | Description | Fee (AED) |
|---|---|---|
| Preliminaries | — | — |
| 1 | Concept Design | 56,000 |
| 2 | Schematic Design | 77,000 |
| 3 | Detailed Design | 91,000 |
| 4 | Tender Documentation | 28,000 |
| 5 | IFC Documentation | 28,000 |
| **Total** | | **280,000** |
...
Post Contract Phase - Time Based Fees: TBC During Design Stages
...
|---|---|---|---|
| — | Mobilisation | 20% | 56,000 |
| 1 | Concept Design | 56,000 | 44,800 |
| 2 | Schematic Design | 77,000 | 65,800 |
| 3 | Detailed Design | 91,000 | 79,800 |
| 4 | Tender Documentation | 28,000 | 16,800 |
| 5 | IFC Documentation | 28,000 | 16,800 |
| **Total** | | **280,000** | |
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference 24-97111-FP r1.
