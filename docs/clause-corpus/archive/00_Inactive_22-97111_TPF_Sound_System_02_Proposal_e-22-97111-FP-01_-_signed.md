...
| Field | Value |
|---|---|
| Project | 22-97111 TPF Sound System |
| Doc ID | e-22-97111-FP-01 - signed |
| Status | 00 Inactive |
| Client Name | Nakheel Malls (Ryan Marginson) |
| Total Fee | AED 166,667 |
| Currency | AED |
...
**Fee Proposal — Audio System Design and Consultancy — Palm Fountain — Dubai, U.A.E.**

e-22-97111-FP
Release 01
29 July 2022

Fee Proposal for Design and Consultancy of Audio System — Palm Fountain
...
- Bars - Brand Activations - Casual Dining Venues - Cinemas - Corporate Headquarters - Department Stores - Family Entertainment Centres - Galleries - Gaming Venues - Hotels - Landmark Buildings - Landscape - Malls - Museums - Nightclubs - Offices - Parks - Performance Venues - Public Realm - Retail Flagships - Shopping Centres - Spas - Theatres - Theme Parks -
...
The Project is known as Palm Fountain and is located in The Pointe, Dubai, U.A.E.
...
Areas — The proposed scope includes the following areas:
- Fountain Performance Audio System

The proposed scope excludes the following areas:
- Temporary or portable event sound systems
- General BGM speakers across the property
- BoH Areas
- Tenanted spaces
...
## Scope & Services — Stage 2

**Stage 2 - Concept Design [RIBA]**

We will prepare a Audio System Concept Design Report for the Project which will provide guidelines for the Client and other Designers to ensure that the Audio System concepts are in line with the overall Project aspirations. This report shall be based on coordination with other Designers / Consultants as well as requirements of the Client.
...
- Concept Design Report:
  ...
  - Assistance with preparation of defined package budget including outline report

We have allowed for up to one revision of the Concept Design Report.

---

## Scope & Services — Stage 3
...
| 2 | Concept Design | 2 weeks |
| 3 | Developed Design | 2 weeks |
| 4 | Technical Design | 3 weeks |
...
|---|---|---|
| 1 | Preliminaries | 25,000 |
| 2 | Concept Design | 50,000 |
| 3 | Developed Design | 50,000 |
| 4 | Technical Design | 41,667 |
| **Total** | | **166,667** |
...
We propose the following payment structure for the primary services by design phase:

| Stage | Milestone | Fee (AED) | Payment (AED) |
|---|---|---|---|
| Mobilisation | | | 50,000 (30%) |
| 1 | Preliminaries | 25,000 | 12,500 |
| 2 | Concept Design | 50,000 | 37,500 |
| 3 | Developed Design | 50,000 | 37,500 |
| 4 | Technical Design | 41,667 | 29,167 |
| **Total** | | **166,667** | |

Any Post Contract Fees will be invoiced monthly.
...
- Daily billing rates applicable to this project will be AED 4,200 per day per person, excluding travel, accommodation and ancillary costs.
...
In all events, emittiv's liability to the Client under any circumstances exceeding the amount of compensation actually received by emittiv from the Client under any related Agreement as of a certain date.
