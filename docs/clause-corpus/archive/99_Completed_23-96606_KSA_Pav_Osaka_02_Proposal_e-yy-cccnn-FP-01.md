...
| Field | Value |
|---|---|
| Project | 23-96606 KSA Pav Osaka |
| Doc ID | e-yy-cccnn-FP-01 |
| Status | 99 Completed |
| Client Name | Client Company |
| Total Fee | Not stated (template placeholders in fee tables) |
| Currency | AED |
...
**Fee Proposal — Sensory Design Design and Consultancy**

make:sense

Fee Proposal
Sensory Design Design and Consultancy
Project Name
...
yymmdd | 01 | Martin Robert, Contact Name
...
emittiv ["Consultant", "We"] have received a Request for Proposal from Client Company ["Client"].
...
Project Details
The Project is known as Project Name and is located in Project Area, Project City, Project Country.
The Project is a proposed new development and currently comprises of:
• Total Plot Area:
  - Approximately xxx m2
• Total Floors:
  - Approximately xxx m2
...
• Design Phase
  ...
  - Stage 4a  Tender Documentation
  - Stage 4b  Tender Return Review
• Post Contract Phase
...
## Scope & Services — Overview

Services
This proposal includes the services described below and is divided into Stages 1-7. xxx
...
## Stages — Stage 1 Preliminaries

**Stage 1 - Preliminaries [RIBA]**
...
## Stages — Stage 3 Developed Design

**Stage 3 - Developed Design [RIBA]**
...
## Stages — Stage 4 Technical Design

**Stage 4 - Technical Design [RIBA]**
...
## Stages — Stage 4a Tender Documents

**Stage 4a - Tender Documents**
...
## Stages — Stage 4b Tender Return Evaluation
...
## Stages — Stage 5 Construction Supervision

**Stage 5 - Construction Supervision [RIBA]**
...
## Stages — Stage 5a Focussing / Aiming and Scene Setting
...
## Stages — Stage 6 Hand Over and Close Out

**Stage 6 - Hand Over and Close Out [RIBA]**
...
## Stages — Stage 7 Post Completion / DLP
...
|---|---|---|
| 1 | Preliminaries | 1 week |
| 2 | Concept Design | 6 weeks |
| 3 | Developed Design | 10 weeks |
| 4 | Technical Design | 12 weeks |
| 4a | Tender Documentation | 8 weeks |
| 4b | Tender Return Review | 3 weeks |

Post Contract Phase

| Stage | Milestone | Duration |
|---|---|---|
| 5 | Construction Supervision | 18 visits |
| 5a | Scene Setting | 3 visits |
| 6 | Handover | 1 week |
| 7 | DLP | 12 months |

**Site Attendance**

We understand that all works are to be undertaken in conjunction with the Client's Client City based office.
...
| Stage | Milestone | Fee | Total |
|---|---|---|---|
| 1 | Preliminaries | [not stated] | |
| 2 | Concept Design | [not stated] | |
| 3 | Developed Design | [not stated] | |
| 4 | Technical Design | [not stated] | |
| 4a | Tender Documentation | [not stated] | |
| 4b | Tender Return Review | [not stated] | |
...
|---|---|---|---|---|---|
| 5 | Construction Supervision | month | 18 | [not stated] | [not stated] |
| 5a | Scene Setting | visit | 3 | 10,000 | 30,000 |
| 6 | Handover | visit | 2 | 8,400 | 16,800 |
| 7 | DLP | visit | 3 | 8,400 | 25,200 |

Estimated Total: [not stated in template]
...
VAT is applicable to this proposal and shall be added to all invoices at the prevailing rate. xxx
...
Post Contract Fees will be invoiced monthly. Internal time sheets will be provided on request. xxx
...
emittiv accepts payment in stable coin currencies [USDT and USDC.] Payments made by this method are eligible for a 2.5%xxx discount. Please let us know if you are interested in pursuing this option.
...
Next Steps
If you would like to proceed with this project, please issue an LPO mentioning the document reference e-yy-cccnn-FP r01.
