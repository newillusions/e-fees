...
| Field | Value |
|---|---|
| Project | 23-97101 Marina Island Financial District |
| Doc ID | e-23-97101-FP-01 (e-23-97101-LI-FP Release 01) |
| Status | 00 Inactive |
| Client Name | P&T Group (Hala Naber, Business Development Manager) |
| Total Fee | AED 840,000 (Design Phase lump sum) + AED 1,098,400 (estimated post-contract) |
| Currency | AED |
...
Marina Island Financial District
Abu Dhabi, U.A.E.
e-23-97101-LI-FP
Release 01
...
- Plot Footprint: Approximately 40,000 m2
- GFA allocation: 60% of Offices, 5%-10% Retail, 30%-35% of Residential Apartments
- Gross Floor Area (GFA): Approximately 130,000 – 135,000 m2

**Reference Documents**
Reference documents provided by the Client, which form the basis of this proposal include:
- Email request of 13 Dec 2022
- Appendix B-Abu Dhabi Marina Island - Concept Plan Extract for Finance District.pdf
- Appendix B-Abu Dhabi Marina Island Financial Disctrict - Site plan.pdf
- CoC -Consultancy Service - Part l and ll.pdf
- RFP_Proposed Marina Island Financial District Construction.pdf
- Tender Clarification Request No 1 -21 Dec 22.pdf
...
- Street Lighting is Excluded from the project scope as confirmed by email
- The project is to be developed using BIM systems
...
**Stage 6 – Construction Supervision [RIBA]**
Typical deliverables include:
...
**Stage 6b – Hand Over and Close Out [RIBA]**
Typical deliverables include:
...
| 2 | Schematic Design | 10 weeks |
| 3 | Detailed Design | 12 weeks |
| 4 | Tender Documentation | 8 weeks |
| 5 | Tender Return Review | 3 weeks |
...
| Stage | Milestone | Duration |
|---|---|---|
| 6 | Construction Supervision | 36 visits |
| 6a | Scene Setting | 10 visits |
| 6b | Handover | 3 weeks |
| 7 | DLP | 12 months |
...
|---|---|---|
| — | Preliminaries | — |
| 1 | Concept Design | 84,000 |
| 2 | Schematic Design | 210,000 |
| 3 | Detailed Design | 252,000 |
| 4 | Tender Documentation | 210,000 |
| 5 | Tender Return Review | 84,000 |
| | **Total** | **840,000** |
...
|---|---|---|---|---|---|
| 6 | Construction Supervision | month | 36 | 22,000 | 792,000 |
| 6a | Scene Setting | visit | 10 | 10,000 | 100,000 |
| 6b | Handover | week | 3 | 52,000 | 156,000 |
| 7 | DLP | visit | 3 | 16,800 | 50,400 |
| | **Estimated Total** | | | | **1,098,400** |
...
|---|---|---|---|
| — | Mobilisation | — | 252,000 (30%) |
| — | Preliminaries | — | — |
| 1 | Concept Design | 84,000 | 33,600 |
| 2 | Schematic Design | 210,000 | 159,600 |
| 3 | Detailed Design | 252,000 | 201,600 |
| 4 | Tender Documentation | 210,000 | 159,600 |
| 5 | Tender Return Review | 84,000 | 33,600 |
| | **Total** | **840,000** | |
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference e-23-97101-LI-FP r01.
