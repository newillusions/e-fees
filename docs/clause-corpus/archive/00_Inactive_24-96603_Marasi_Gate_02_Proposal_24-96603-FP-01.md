...
**Project:** 24-96603 Marasi Gate Retail Block
**Doc ID:** 24-96603-FP-01
**Status:** 00 Inactive
**Client:** Afniah Architects + Engineers (Abdulsattar Al Hulaimy)
**Total Fee:** 325,000 SAR (exclusive of VAT and expenses)
**Currency:** SAR
...
|------|---------|--------------|
| 240808 | 01 | Martin Robert, Abdulsattar Al Hulaimy |
...
emittiv ["Consultant", "We"] have received a Request for Proposal from Afniah Architects + Engineers ["Client"].

Reference documents provided by the Client, which form the basis of this proposal include:
- Email request of 06 Aug 2024
- 2024-06-Marasi Gate _ Lighting highlighted.pdf
- PROJECT PROPOSED TIMEFRAME.pdf
...
The Project is known as Marasi Gate Retail Block and is located in Marasi Neighborhood, Khobar, K.S.A.

The Project is a proposed new development and currently comprises of:
- Total Plot Area: Approximately 29,800 m2
- Total Floors: Max 6 [G+M+5.5] and basement
...
- Lighting:
  ...
  - Interior scope is limited to public lobbies and corridors etc.
...
| 2 | Schematic Design | 7 weeks |
| 3 | Developed Design | 7 weeks |
| 4 | Tender Documentation | 7 weeks |

**Site Attendance**

We understand that all works are to be undertaken in conjunction with the Client's Dammam based office.
This proposal does not provide for any travel out of country. If required, visits will be charged at the prevailing daily rates, plus travel and accommodation costs.
...
| Stage | Milestone | Fee (SAR) |
|-------|-----------|-----------|
| - | Preliminaries | - |
| 1 | Concept Design | 81,250 |
| 2 | Schematic Design | 97,500 |
| 3 | Developed Design | 113,750 |
| 4 | Tender Documentation | 32,500 |
| | **Total** | **325,000** |
...
All prices shown are in SAR.
All rates are exclusive of VAT and expenses.
Saudi Withholding Tax is applicable to this proposal and shall be added to all invoices at the prevailing rate.
Submittal of deliverables shall be the trigger for invoices of each stage.
...
Note: Draft / 50% submittals for stages shall be invoiced accordingly.
...
Daily billing rates applicable to this project will be SAR 4,800 per person per day, excluding travel, accommodation and ancillary costs.
...
| Stage | Milestone | Fee (SAR) | Payment (SAR) |
|-------|-----------|-----------|---------------|
| - | Mobilisation | - | 48,750 (15%) |
| 1 | Concept Design | 81,250 | 69,063 |
| 2 | Schematic Design | 97,500 | 85,313 |
| 3 | Developed Design | 113,750 | 101,563 |
| 4 | Tender Documentation | 32,500 | 20,313 |
| | **Total** | **325,000** | |
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference 24-96603-FP r01.
