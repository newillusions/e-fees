...
| Doc ID | 25-97106-FP-02 |
| Status | 11 Current |
| Client | Sim Leisure Gulf Contracting LLC |
| Total Fee | AED 220,000 |
| Currency | AED |
...
|---|---|---|---|
| 250716 | 02 | MR | Updated Scope and Programme |
| 250623 | 01 | MR | RFP |
...
|---|---|---|
| 250716 | 02 | Martin Robert, Josie Booth |
...
## Stages — Stage 1: Concept Design Review
...
| Stage/Milestone | Description | Duration |
|---|---|---|
| Preliminaries | — | 1 week |
| Stage 1 | Concept Design | 6 weeks |
| Stage 2 | Detailed Design | 7 weeks |
...
| Stage/Milestone | Description | Fee (AED) |
|---|---|---|
| Preliminaries | — | — |
| Stage 1 | Concept Design | 55,000 |
| Stage 2 | Detailed Design | 121,000 |
| Stage 3 | Tender Documentation | 44,000 |
| **Total** | | **220,000** |
...
|---|---|---|---|
| — | Mobilisation (25%) | — | 55,000 |
| 1 | Concept Design | 45,000 | 36,667 |
| 2 | Detailed Design | 99,000 | 102,667 |
| 3 | Tender Documentation | 36,000 | 25,667 |
| **Total** | | **220,000** | |
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference 25-97106-FP r02.
