# Archive: 25-97102-FP-01

| Field | Value |
|---|---|
| Project | 25-97102 WAMI |
| Doc ID | 25-97102-FP-01 |
| Status | 11 Current |
| Client Name | Wynn Al Marjan Island FZ-LLC |
| Total Fee | AED 1,069,440 (Review and Report Phase; Post Contract fees TBC/time-and-material) |
| Currency | AED |
...
**Fee Proposal — Specialist Lighting Sitewide Lighting Consultancy**
...
Date: 250502 | Release: 01 | Author: MR | Reference: RFP

Distribution

Date: 250502 | Release: 01 | Distribution: Martin Robert, Derek Sands, Quincy Bernal-lalic, Chris Ward, Richard Hextall, LihChuan Liew

Confidential. This document contains sensitive commercial information. It must not be reproduced or distributed without the express written permission of emittiv. This document and its contents are only applicable to the named project, for the named Client.
...
**Expo 2020**
Role: Site Wide Lighting Consultant
Duration: 2019-2022
- Conducted peer review of the existing and in progress lighting designs across the entire site.
- Made recommendations for event enhancements as appropriate.
- Oversaw lighting commissioning and aiming sessions.
- Validated all control groups.
- Developed unified lighting scenes and schedules across all parcels.
- Provided additional lighting designs as changes emerged.
- Ongoing site inspections during event.
- Updated programming on site as required

**Previous Works**

Emittiv has undertaken similar roles in the past, on equivalent scale projects. A selection of references includes:

SeaWorld
Role: Specialist Consultant to Contractor | Duration: 2020-2021
We were nominated to the awarded Contractor by the Client's Representative to assist in coordinating the ongoing designs and ensuring appropriate products were provided to the project.
- Reviewed all contractor nominated fixtures to ensure suitability and conformance with requirements
- Implemented Revit plans and systems for lighting package
- Directed, Reviewed, and Validated all lighting modelling and calculations
- Liaised with manufacturers for custom fixture designs [thematic and animal welfare]
- Assisted contractor to interpret and implement ongoing design changes

House of Hype
Role: Lighting Designer | Duration: 2022-2025
Interactive indoor theme park of 100,000m2 with significant dynamic and integrated components. Over 30 unique spaces with individual designs and control.
- Initial review of ID and Architect concepts
- Complete Lighting Design development [CD through IFT]
- Ongoing redesigns and updates
- Review Contractor Submittals and Shop Drawings
- Ongoing installation inspections
- Commissioning Supervision and Validation
- Develop lighting scenes, interactive triggers, and schedules
- Supervise Programming and Aiming

Rua al Medina - SuperBlock 5
Role: Lighting Designer | Duration: 2022-2025
Large Scale Segment of new city development. 120,000m2 plot encompassing 10 high rise towers, public realm internal roadways, and underground car parks.
- Public Realm Lighting Design
- Underground Car-park and Drop-off Area Lighting Design
- Complete Lighting Design development [CD to IFC]
- Ensure SuperBlock designs are aligned with Master Plan
- Ongoing Design Development and responding to changes
- Completed lighting and power calculations for car parks and public roadways

---

## Scope & Services — Project Understanding

**Project Understanding**

emittiv ["Consultant", "We"] have received a Request for Proposal from Wynn Al Marjan Island FZ-LLC ["Client"].
...
- Email request of 18 Apr 2025
- Sitewide Lighting Consultant Services RFP 18.04.2025 - Emittiv LLC.pdf
- Appendix 1_Scope of Services_18.04.25.pdf
- Appendix 2_Drawings: Appendix 2_Drawings.pdf; 2024-12-20_B_Combined_MP-LR_A0.pdf; WAMI-HKS-AR-DRW-TWVL-20010 - 20013 OVERALL ELEVATIONS.pdf
- Appendix 3_Consultant Agreement.pdf

**Project Details**
The Project is known as Wynn Al Marjan Island and is located in Marjan Island, Ras Al Khaimah, U.A.E.
- Total Floor Area: Approximately 600,000 m2 [as indicated in supplied documentation]
- Total Floors: B2 - 70 [as indicated in supplied documentation]
...
**Areas**
The proposed scope includes [without limitation] the following areas:
- Lighting:
  - Main lobby and circulation areas
  - Gaming areas and sports book
...
- **Back of House**: Back of House areas will be reviewed on a case by case basis.

We have provided some suggested additions to support this.
...
**Review and Report Phase — Preliminaries**
...
## Stages — Stage 1: Information Gathering and Initial Report
...
- Comment on package requirements [such as lux levels, uniformities, etc., as appropriate]
- Initial Reviews and Comments on fixture and accessory specifications.
- Initial Reviews and Comments on fixture control grouping.
- Initial Reviews and Comments on lighting zone interfaces and potential issues or design scope gaps.
- Conduct initial discussions with each Lighting Design team to develop an understanding of their overall intent and strategy.
- Develop outline of final report in conjunction with the Client.
- Review agreed scope and staffing to confirm validity.
- Provide Comments and Recommendations for future Stages of the Works

---

## Stages — Stage 2: Report and Recommendations
...
Specified deliverables include:
- Develop sitewide maps showing the limits of each lighting control system and interfaces / overlaps with the adjacent lighting systems, and update as additional lighting designs become available
- Develop matrix showing interfaces and interdependencies between lighting control system, and update as additional lighting designs become available
- Provide guidance to the design team / contractor where the lighting control system has not been defined within the project design.
- Develop a site wide lighting control strategy documents detailing requirements for each system and recommend options for centralised monitoring and control of area specific lighting control systems including automated control and manual override.
- Support the design teams in development of lighting scenes and obtaining client approval.
- Where areas are under design development, advise lighting designers of similar fitting used in other areas for procurement gains and reduced attic stock.
- Update initial report to include any new information and above noted deliverables and make recommendations as noted, and present.

Recommended additional scope elements:
- Identify integration points with other systems as required
- Additional reviews of package requirements [such as lux levels, uniformities, etc., as appropriate]
- Additional Reviews and Comments on fixture and accessory specifications.
- Additional Reviews and Comments on fixture control grouping.
- Additional Reviews and Comments on lighting zone interfaces and potential issues or design scope gaps.
- Conduct additional discussions with each Lighting Design team to clarify any outstanding issues [as required].
- Review agreed scope and staffing to confirm validity.
- Provide Comments and Recommendations for future Stages of the Works
...
**Post Contract Phase — Stage 3: On-going Support and Validation**
...
**Contract Details — Anticipated Programme**
...
| Stage | Milestone | Duration |
|---|---|---|
| Preliminaries | - | 2 weeks |
| 1 | Information Gathering | 6 weeks |
| 2 | Report and Recommendations | 8 weeks |

**Post Contract Phase**

| Stage | Milestone | Duration |
|---|---|---|
| 3 | On-going Support and Validation | TBC |

**Site Attendance**

We understand that all works are to be undertaken in conjunction with the Client's Ras Al Khaimah based office. This proposal does not provide for any travel out of country. If required, these will be charged at the prevailing daily rates, plus travel and accommodation costs. In the interest of efficiency and safety, emittiv prefers remote meetings wherever possible.

---

## Design Phase Fees

**Review and Report Phase Fee Estimates**
...
|---|---|---|
| 1 | Information Gathering | 483,360 |
| 2 | Report and Recommendations | 586,080 |
| **Total** | | **1,069,440** |
...
**On-going Support and Validation Phase Fee Estimates**
...
| Stage | Milestone | Unit | Est. Weekly Fee (AED) |
|---|---|---|---|
| 3a | Light Off-Site Involvement | week | 10,680 |
| 3b | Medium Off-Site Involvement | week | 26,160 |
| 3c | Heavy Off-Site Involvement | week | 84,960 |
| 3d | Light On-Site Involvement | week | 85,360 |
| 3e | Medium On-Site Involvement | week | 135,560 |
| 3f | Heavy On-Site Involvement | week | 185,760 |

Estimated Total: Please note that we do not currently have sufficient information to estimate these fees. Refer to Proposed Deployment section for indicative staffing of these configurations.
...
All rates are exclusive of VAT and expenses. VAT is applicable to this proposal and shall be added to all invoices at the prevailing rate.
...
**Payment Schedule - Review and Report Phase**

| Stage | Milestone | Fee (AED) | Payment (AED) |
|---|---|---|---|
| Mobilisation | - | - | 320,832 (30%) |
| 1 | Information Gathering | 483,360 | 322,944 |
| 2 | Report and Recommendations | 586,080 | 425,664 |
| **Total** | | **1,069,440** | |

**On-going Support and Validation Phase Fees**
To be invoiced monthly on a Time and Material basis. Internal time sheets will be provided on request.
...
**Proposed Deployments — Review and Report Phase**

Staff rates (AED per week):
| Role | Weekly Fee |
|---|---|
| Partner | 49,400 |
| Project Director | 35,200 |
| Design Manager | 30,800 |
| Project Manager | 31,800 |
| Senior Consultant | 27,200 |
| Consultant | 20,800 |
| BIM Manager | 27,400 |
| BIM Operator | 16,800 |
| 3D Digital Modeller | 18,200 |
| 2D Drafting | 15,600 |
| 2D Visualisation | 26,200 |
| Site Manager | 33,000 |
| Site Consultant | 29,400 |
| Site Technician | 20,800 |
| Coordinator | 16,200 |
| Administrative Support | 10,800 |

Stage 1 Total Fees: 483,360 AED | Stage 2 Total Fees: 586,080 AED | Overall Total: 1,069,440 AED

**On-going Support and Validation Phase — Stage 3 Deployment Configurations**

| Stage | Configuration | Weekly Fee (AED) |
|---|---|---|
| 3a | Light Off-Site | 10,680 |
| 3b | Medium Off-Site | 26,160 |
| 3c | Heavy Off-Site | 84,960 |
| 3d | Light On-Site | 85,360 |
| 3e | Medium On-Site | 135,560 |
| 3f | Heavy On-Site | 185,760 |

Typical expected deployment configurations during construction supervision stages. Indicative estimates only.

---

## Other — Indicative Team

**Indicative Team**

Martin Robert — emittiv founder, Lighting and Control Specialist
Specialties: Lighting, Video, Control Systems
Martin's career has spanned many facets of lighting and video from global tours with A-List artists, permanent installations on iconic buildings to consulting for global events for more than 30 years. His current development is centred on dynamic, generative and communicative control systems.
Key Experience: Expo 2020 - Site Wide Lighting Consultant; Seaworld Abu Dhabi - Specialist Lighting Consultant; House of Hype DXB - Lighting Designer; Rua Al Medina SB5 - Lighting Designer; Dubai Parks and Resorts - Upgrade Lighting Design; Al Imam University - 2500 seat theatre renovation; Sheikh Zayed Grand Mosque - Upgrade Project Manager; Cirque du Soleil - Multiple Resident Show builds.

Sky Bembury — Lighting Designer
Specialties: Lighting Design, Product Development, Control Systems
For over 20 years, Sky has been working across the USA, Europe and the Middle East. His experience encompasses Architectural & Entertainment Lighting Design, Product & Project Management, and Business Development. Sky's previous work has included many hotels, restaurants and residences. Sky also acts as our lead designer for custom fittings and fixtures.
Key Experience: Expo 2020 - Site Wide Lighting Consultant; Mercure Hotel, Dubai; Novokov Restaurant; New Court (Rothschilds); Fly Dubai HQ, Exterior.

Ryan Marginson — Lighting Designer and Project Manager
Specialties: Lighting Design, Technical Direction, Project Management
Ryan brings 20 years' experience across Australia, Asia and the Middle East. His extensive history of working on large scale entertainment and event projects provides him with an exceptional basis for managing schedules, budgets and governmental requirements. Ryan is an accomplished creative and technical designer, having managed a number of significant project builds, upgrades and launches.
Key Experience: The Pointe Fountain - Technical Director; Nakheel - Senior Manager - Technical Production; JK58 - Managing Director / Technical Director; Burj Khalifa New Year's Eve; Marina bay Sands hotel - Sound and Light Show.

Daryl Bowen — Lighting Control Specialist
Specialties: Lighting Design, System Commissioning, Control Systems
Daryl's lighting career spans more than 30 years. During this time, he has contributed to a wide variety of large scale events and installations. He continues to work across the globe, and has so far been involved with projects in UK, Europe, Africa, Middle East, Asia, and Oceania. An accomplished Lighting Control specialist, Daryl is equally at home programming lighting consoles as he is trouble shooting networks and power supplies.
Key Experience: Seaworld Abu Dhabi - Show Design and Programming; House of Hype DXB - Lighting Programmer; Dubai Festival City "Imagine" - Head of Lighting; Marina Bay Sands Singapore - Head of Lighting; Cirque du Soleil - Zaia Show Build and Opening.

Goran Salkovic — Lighting Designer and Project Manager
Specialties: Installation Supervision, System Commissioning, Control Systems
With over 20 years' experience, Goran has developed a thorough understanding of lighting systems and installations. His background in running large scale events and high profile venues has sharpened his ability to resolve issues on site, resulting in optimised systems. Goran is also an experienced system programmer, and always has an eye on the end result throughout the construction process.
Key Experience: Expo 2020 - Site Wide Lighting Consultant; Expo 2020 - Al Wasl Dome Operations; Coca Cola Arena - Head of Lighting; Dubai Opera - Lighting Programmer And Operator; FIFA World Cup - System Engineer And Console Operator.

Notes: The proposed staff are indicative of the calibre of specialists emittiv typically provide to our projects. All nominated staff work independently in the region, and have previously been engaged by emittiv on various projects. Specific staff shall be identified and confirmed in conjunction with the Client upon award and as deployment needs arise.
...
**Staff Rates**
Current as of January 2025. Prices are shown in AED.

| Role | Hour | Day | Week | Month |
|---|---|---|---|---|
| Partner | 1,235 | 9,880 | 49,400 | 217,360 |
| Project Director | 880 | 7,040 | 35,200 | 154,880 |
| Design Manager | 770 | 6,160 | 30,800 | 135,520 |
| Project Manager | 795 | 6,360 | 31,800 | 139,920 |
| Senior Consultant | 680 | 5,440 | 27,200 | 119,680 |
| Consultant | 520 | 4,160 | 20,800 | 91,520 |
| BIM Manager | 685 | 5,480 | 27,400 | 120,560 |
| BIM Operator | 420 | 3,360 | 16,800 | 73,920 |
| 3D Digital Modeller | 455 | 3,640 | 18,200 | 80,080 |
| 2D Drafting | 390 | 3,120 | 15,600 | 68,640 |
| 2D Visualisation | 655 | 5,240 | 26,200 | 115,280 |
| Site Manager | 825 | 6,600 | 33,000 | 145,200 |
| Site Consultant | 735 | 5,880 | 29,400 | 129,360 |
| Site Technician | 520 | 4,160 | 20,800 | 91,520 |
| Coordinator | 405 | 3,240 | 16,200 | 71,280 |
| Administrative Support | 270 | 2,160 | 10,800 | 47,520 |

Time definitions: 1 day = 8 hrs; 1 week = 5 working days (Monday to Friday); 1 month = 22 working days.
Where applicable, VAT shall be added at the prevailing rate.
Site Visits incur a minimum full day fee.
Travel time shall be charged outside of Dubai city. Consecutive multi-day visits may require additional accommodation and per diem fees. This shall be agreed with the Client upon request.
...
Our appointment shall be subject to and in accordance with the FIDIC Client / Consultant Model Services Agreement - 5th Ed (2017 White Book). The terms and general conditions laid out in the 2017 White Book shall form part of this proposal and be read as contained herein.
...
In principle we have no objection to working under the FIDIC Client / Consultant Model Services Agreement [White Book], though we note that the proposed contract is based on the 2006 version rather than the current 2017 edition.
We further note that there are number specific conditions which alter the standard contract. These amendments will be reviewed and discussed prior to engagement.
We also make mention of the fact that the proposed contract does not include the offer of the Consultant as a governing document, which will need to be remedied prior to proceeding.
...
## Other — Company Insurance

**Company Insurance**

Professional Indemnity:
emittiv maintains Professional Indemnity insurance coverage of $10m USD for each and every claim. This policy is currently being renewed and will be issued to the Client prior to the commencement for works. To date, there have been no previous claims against emittiv for any reason.

Third-Party Liability:
emittiv DOES NOT currently maintain Third-Party or Public Liability coverage, as this does not typically cover our business activities or works. Please advise if this is a firm requirement for the WAMI project, and we will investigate available options.
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference 25-97102-FP r1.
