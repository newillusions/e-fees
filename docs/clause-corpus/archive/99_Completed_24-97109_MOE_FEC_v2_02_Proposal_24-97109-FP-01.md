...
**Project:** 24-97109 MOE FEC v2
**Doc ID:** 24-97109-FP-01
**Status:** 99 Completed
**Client:** Sim Leisure Gulf Contracting LLC
**Total Fee:** AED 335,000
**Currency:** AED
...
**Fee Proposal — Sensory Systems Design and Consultancy**
MAF MOE FEC
Dubai, U.A.E.
24-97109-FP
Release 01
...
|------|---------|--------------|
| 240708 | 01 | Martin Robert, Josie Booth |
...
- Email request of 03 July 2024
- 1559-LDA-Mall of the Emirates - 00 0111 - Leisure Avenue Proposed First Floor with Layouts.pdf
- 1559-LDA-Mall of the Emirates- 00 0211 - Leisure Avenue Proposed Second Floor with Layouts.pdf
- 2024 06 18 Leisure Avenue ID Design Development.pdf

**Project Details**

The Project is known as MAF MOE FEC and is located in Al Barsha, Dubai, U.A.E. The Project is a proposed new development and currently comprises of:

- Kids: Approximately 2,532 m2
- Teens: Approximately 1,875 m2
- First Floor Activation: Approximately 54 m2
...
- All Packages: All areas Front of House spaces within the space
...
**Stage 1 - Concept Design Review and Update**

We will prepare a Sensory Systems Concept Design Report for the Project which will provide guidelines for the Client and other Designers to ensure that the Sensory Systems concepts are in line with the overall Project aspirations. This report shall be based on coordination with other Designers / Consultants as well as requirements of the Client.

This report shall review the existing concept design previously prepared for suitability with the new and updated designs.
...
- Carry out development of package specific 2D layouts based on linked files
- Prepare package layouts
- Assist others with the coordination of the package design
- Prepare package equipment schedule
...
| Milestone / Stage | Duration |
|-------------------|----------|
| Preliminaries | 1 week |
| Stage 1 - Concept Design | TBC |
| Stage 2 - Detailed Design | 8 weeks |
| Stage 3 - Tender Documentation | 2 weeks |

Note: Concept Design duration shall be dependent on receiving completed packages prepared by others.
...
|-------------------|-----------|
| Preliminaries | — |
| Stage 1 - Concept Design | 83,750 |
| Stage 2 - Detailed Design | 184,250 |
| Stage 3 - Tender Documentation | 67,000 |
| **Total** | **335,000** |
...
|-------|-----------|-----------|---------|
| — | Mobilisation | 83,750 | 25% |
| 1 | Concept Design | 55,834 | — |
| 2 | Detailed Design | 156,333 | — |
| 3 | Tender Documentation | 39,083 | — |
| — | **Total** | **335,000** | — |
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference 24-97109-FP r01. If you have any questions, or would like to discuss this further, please do not hesitate to contact us. We look forward to working with you on this project.
