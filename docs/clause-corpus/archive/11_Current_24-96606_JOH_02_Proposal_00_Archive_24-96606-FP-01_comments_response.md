...
**Project:** 24-96606 JOH (Jeddah Opera House)
**Doc ID:** 24-96606-FP-01 comments response
**Status:** 11 Current
**Client:** Martin Professional Middle East (Ahmad Zaiim, Senior Projects Manager)
**Total Fee:** AED 780,000
**Currency:** AED
...
**Fee Proposal — Specialist Lighting Technical Management**
Jeddah Opera House, Jeddah, K.S.A.
24-96606-FP | Release 1
...
The Project is known as Jeddah Opera House and is located in Al Andalus, Jeddah, K.S.A. The Project is a proposed new development and currently comprises of:
- 3 Theatre Spaces:
  - Lyric Theatre
  - Midscale Theatre
  - Rehearsal Theatre
...
Note: Stages 2 and 3 are duration based fees and may increase if the project timelines exceed what is currently advised.
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference 24-96606-FP r1.
