...
| Field | Value |
|---|---|
| Project | 25-97105 Shanghai Tang v2 |
| Doc ID | 25-97101-FP-01 |
| Status | 11 Current |
| Client Name | Conrad Hotels (attn: Nicholas Fernandez, Director of Engineering) |
| Total Fee | AED 55,000 (core); AED 82,500 (incl. optional Acoustic Design and Consultancy) |
| Currency | AED |
...
**Fee Proposal — Lighting and Audio Design, Shanghai Tang, Abu Dhabi, U.A.E., 25-97101, Release 01**
...
Date: 250127 | Release: 01 | Author: MR | Reference: RFP

**Distribution**

Date: 250127 | Release: 01 | Distribution: Martin Robert, Andrew Hawkes, Nicholas Fernandez
...
emittiv ["Consultant", "We"] have received a Request for Proposal from Conrad Hotels ["Client"].
...
- Email request of 19 April 2024
- Design Pack info of 22 April 2024

**Project Details**

The Project is known as Shanghai Tang and is located in the Conrad Hotel, Etihad Towers, Abu Dhabi, U.A.E.
...
An optional price for Acoustics Design and consultancy is also included.
...
**Services — Design Phase: Preliminaries**
...
We will prepare a Lighting and Audio Concept Design Report for the Project which will provide guidelines for the Client and other Designers to ensure that the Lighting and Audio concepts are in line with the overall Project aspirations. This report shall be based on coordination with other Designers / Consultants as well as requirements of the Client.
...
In this design phase we further develop and identify the specifics of the systems and their integration with other design disciplines.
...
| 2 | Schematic Design | 2 weeks |
| 3 | Detailed Design | 4 weeks |
| 4 | Tender Documentation | 2 weeks |

We understand that there are time constraints on this project and will endeavour to progress the design as quickly as possible.
...
|---|---|---|
| - | Preliminaries | - |
| 1 | Concept Design | 13,750 |
| 2 | Schematic Design | 16,500 |
| 3 | Detailed Design | 19,250 |
| 4 | Tender Documentation | 5,500 |
| - | **Total** | **55,000** |
...
**Optional Scope:**
Acoustic Design and Consultancy for a lump sum fee of AED 27,500.
...
Optional Acoustic Design and Consultancy Fees would be added to this schedule with a similar payment distribution, if ordered.
...
emittiv accepts payment in stable coin currencies [USDT and USDC.]
Payments made by this method are eligible for a 2.5% discount.
...
|---|---|---|---|
| - | Mobilisation | - | 30% / 16,500 |
| 1 | Concept Design | 13,750 | 9,625 |
| 2 | Schematic Design | 16,500 | 12,375 |
| 3 | Detailed Design | 19,250 | 15,125 |
| 4 | Tender Documentation | 5,500 | 1,375 |
| - | **Total** | **55,000** | - |
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference 25-97101 r01.
If the LPO is issued for a value of AED 82,500 it will be acknowledged that the Acoustic Consultancy has been ordered by the Client.
