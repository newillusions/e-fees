...
**Project:** 24-97105 MAF MiCC Kids
**Doc ID:** 24-97105-FP-01
**Status:** 99 Completed
**Client:** Sim Leisure Gulf Contracting LLC (Josie Booth, General Manager)
**Total Fee:** AED 65,000
**Currency:** AED
...
Date: 230313 | Release: 01 | Author: MR | Reference: RFP

Distribution

Date: 230313 | Release: 01 | Distribution: Martin Robert, Josie Booth, Karen Stojanovski
...
- Email request of 8 Mar 2024
- MIRDIF MAGIC PLANET_KIDS FEC PLAN_Rev.04
- Preliminary Renders
...
## Scope & Services — Project Details and Packages

The Project is known as MAF Kids FEC and is located in Mirdif City Centre, Dubai, U.A.E.

The Project is a proposed new development and currently comprises of:
- Total Plot Area:
  - Approximately 1,985 m2
  - Double height, including elevated play area
...
- Only the Detailed Design stage have been requested. As such, only the final report shall be produced.
- Any changes to the delivered design and/or equipment will be considered variations.
...
## Stages — Stage 1: Detailed Design
...
- Prepare layout and elevation drawings
- Assist others with the coordination of the package design
- Prepare detail drawings where applicable for incorporation into Architect's details
- Prepare equipment schedules and specifications
- Prepare lighting calculations
- Prepare lighting control schematic drawings
...
We propose the following programme, commencing with receipt of a fully executed contract. These estimations of work stage durations do not take into consideration Client review or Revision periods.

Stage 1:
- Milestone: Preliminaries — Duration: 1 week
- Milestone: Detailed Design — Duration: 6 weeks

The durations shown are to be confirmed with the Client during Preliminaries. Requests to reduce deliverable time frames may require additional staff and fees.
...
Stage 1 — Detailed Design — Fee: AED 65,000
Total: AED 65,000
...
Mobilisation payments are to be received prior to any works commencing. Other payments will be required within 14 calendar days after receipt of invoice. Retention is not acceptable.
...
Daily billing rates applicable to this project will be AED 4,500 per person per day, excluding travel, accommodation and ancillary costs. Daily rates for in house staff are available on our rate card.
...
Stage 1:
- Milestone: Mobilisation — Payment: 30% — AED 20,000
- Milestone: Detailed Design — AED 45,000
- Total: AED 65,000
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference 24-97105-FP r01. If you have any questions, or would like to discuss this further, please do not hesitate to contact us. We look forward to working with you on this project.
