...
| Field | Value |
|---|---|
| Project | 23-97105 Tape Theatre |
| Doc ID | e-23-97105-FP-01-AH comments |
| Status | 00 Inactive |
| Client Name | Stickman Tribe Turnkey Projects Contracting LLC (Marcos Cain) |
| Total Fee | AED 120,000 (Design Phase lump sum; Post Contract fees time-based, not fixed) |
| Currency | AED |
...
**Fee Proposal — Audio Design and Consultancy — Tape Theatre Dubai**
...
Stickman Tribe Turnkey Projects Contracting LLC
Dubai, U.A.E.
Email: marcos@stickmantribe.com
Phone: +971.50.435.5034
...
Date: 230523
Release: 01
Distribution: Andrew Hawkes, Marcos Cain
...
Confidential
This document contains sensitive commercial information. It must not be reproduced or distributed without the express written permission of emittiv. This document and its contents are only applicable to the named project, for the named Client.
...
## Cover & Intro — Proposal Response

**Proposal — Response**

emittiv ["Consultant", "We"] have received a Request for Proposal from Stickman Tribe Turnkey Projects Contracting LLC ["Client"].

Reference documents provided by the Client, which form the basis of this proposal include:
- Email request of dd MMM yyyy
- Tape Theatre Dubai concept.pdf
- THE THEATER Design brief.pdf
- WESTIN.pdf
...
## Cover & Intro — Project Details

**Project Details**

The Project is known as Tape Theatre Dubai and is located in Westin Marina, Dubai, U.A.E.
The Project is a proposed new development and currently comprises of:
- Theatre Restaurant - Approx 470m2
- Nightclub - Approx 600m2
- Lounge - Approx 500m2
- Gallery - Approx 445m2
...
## Stages — Stage 1: Concept Design

**Stage 1 - Concept Design**

We will prepare a Audio Concept Design Report for the Project which will provide guidelines for the Client and other Designers to ensure that the Audio concepts are in line with the overall Project aspirations. This report shall be based on coordination with other Designers / Consultants as well as requirements of the Client.
...
- Provide recommendations on package requirements [such as sound levels, intelligibility, and spatialisation as required]
- High level Package Master Plans
- Content recommendations specific to the technology proposed and the venue specifications
...
## Stages — Stage 2: Schematic Design
...
- Prepare preliminary 3D package calculations as appropriate
...
## Stages — Stage 3: Detailed Design
...
- Prepare final 3D package calculations where appropriate
- Prepare final package power requirements
- Clearly outlined and detailed system control programming specification for operations of the venue
- Specify integration points with other systems as required

---

## Stages — Stage 4: Tender Documents
...
Stage 4b - Tender Return Evaluation
Typical deliverables include:
...
## Post Contract Phase Notes — Stage 5: Construction Supervision
...
## Post Contract Phase Notes — Stage 5a: Focussing / Aiming and Scene Setting

**Stage 5a - Focussing / Aiming and Scene Setting**
...
## Post Contract Phase Notes — Stage 6: Hand Over and Close Out
...
## Post Contract Phase Notes — Stage 7: Post Completion / DLP
...
|---|---|---|
| 1 | Concept Design | 2 weeks |
| 2 | Schematic Design | 4 weeks |
| 3 | Detailed Design | 6 weeks |
| 4 | Tender Documentation | 2 weeks |
...
Site Attendance
We understand that all works are to be undertaken in conjunction with the Client's Dubai based office. This proposal does not provide for any travel out of country. If required, these will be charged at the prevailing daily rates, plus travel and accommodation costs.

Post Contract Phase

| Stage | Milestone | Duration |
|---|---|---|
| 5 | Construction Supervision | xxx visits |
| 5a | Scene Setting | xxx visits |
| 6 | Handover | xxx week |
| 7 | DLP - 1 visit every xxx months | xxx visits |
...
**Fees — Design Phase - Lump Sum Fees**
...
|---|---|---|
| 1 | Concept Design | 40,000 |
| 2 | Schematic Design | 35,000 |
| 3 | Detailed Design | 35,000 |
| 4 | Tender Documentation | 10,000 |
| | **Total Fee** | **120,000** |
...
**Fees — Post Contract Phase - Time Based Fees**
...
Construction Supervision is estimated on 1xxx visit per month.
...
| Stage | Milestone | Unit | Est Qty | Price | Est. Fee |
|---|---|---|---|---|---|
| 5 | Construction Supervision | month | - | - | - |
| 5a | Scene Setting | visit | - | - | - |
| 6 | Handover | visit | - | - | - |
| 7 | DLP | visit | - | - | - |
| | | | | Estimated Total | - |
...
|---|---|---|---|
| - | Mobilisation | - | 30% / 40,000 |
| 1 | Concept Design | 40,000 | 30,000 |
| 2 | Schematic Design | 35,000 | 25,000 |
| 3 | Detailed Design | 35,000 | 25,000 |
| 4 | Tender Documentation | 10,000 | 0 |
| | Total | 120,000 | - |
...
**Additional Payment Terms — Daily Rates and Expenses**
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference e-23-97105-FP r01.
If you have any questions, or would like to discuss this further, please do not hesitate to contact us.
We look forward to working with you on this project.

Sincerely,
Andrew Hawkes - Founder and Audio Director - emittiv llc-fz
