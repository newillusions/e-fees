# Archive: 25-97107-FP-01

| Field | Value |
|---|---|
| Project | 25-97107 Cove Boulevard |
| Doc ID | 25-97107-FP-01 |
| Status | 00 Inactive |
...
**Fee Proposal — External Lighting Design and Consultancy — Cove Boulevard — Dubai, U.A.E. — 25-97107-FP — Release 1**

Document Control:
- Date: 250718 | Release: 01 | Author: MR | Reference: RFP
- Distribution: 250718 | Release: 01 | Martin Robert, Irene Nale
...
emittiv ["Consultant", "We"] have received a Request for Proposal from Imtiaz Developments ["Client"].

Reference documents provided by the Client, which form the basis of this proposal include:
- Email request of 10 July 2025
- Visuals provided on 16 July 2025
...
The Project is known as Cove Boulevard and is located in Wadi Al Safa 5, Dubai, U.A.E.
The Project is a proposed new development and currently comprises of:
- Total Floors: 2B + G + 3P + 31 + Roof
...
- Lighting:
  ...
  - Related Lighting Control Systems
...
We will prepare a External Lighting Concept Design Report for the Project which will provide guidelines for the Client and other Designers to ensure that the External Lighting concepts are in line with the overall Project aspirations. This report shall be based on coordination with other Designers / Consultants as well as requirements of the Client.
...
- Carry out preliminary development of package specific 2D layouts based on linked files
...
- Carry out further development of package specific 2D layouts based on linked files to LOD 300 standards
...
**Stage 4a - Tender Return Evaluation**
...
|---|---|---|
| Preliminaries | Preliminaries | 1 week |
| 1 | Concept Design | 4 weeks |
| 2 | Schematic Design | 8 weeks |
| 3 | Detailed Design | 10 weeks |
| 4 | Tender Documentation | 6 weeks |
| 4a | Tender Return Review | 3 weeks |
...
If you would like to proceed with this project, please issue an LPO mentioning the document reference 25-97107-FP r1. If you have any questions, or would like to discuss this further, please do not hesitate to contact us. We look forward to working with you on this project.
